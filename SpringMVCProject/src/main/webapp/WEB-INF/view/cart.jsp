...
<div class="container">
                ...
                <c:forEach items="${cartProductsList}" var="product">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <br>
                            <a href="${contextPath}/cart/delete/${product.getKey()}" class="btn btn-primary">Удалить</a>
                            <br>
                        </td>
                    </tr>
                    </tbody>
        ...
        <a href="${contextPath}/cart/clear" class="btn btn-primary">Очистить корзину</a>
        <a href="${contextPath}/cart/confirmOrder" class="btn btn-primary">Купить</a>
</div>
</body>
</html>
